...
print(f"SELECT distinct rawf_subscriber_id  FROM oimc.raw_flows where rawf_begin_connection_time > '{date_for_login}' and rawf_subscriber_id != 'operator' limit 100")
